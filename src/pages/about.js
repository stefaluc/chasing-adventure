        ...
        <Layout location={this.props.location}>
            ...
            <div style={{ background: '#fff' }}>
                <div className="wrapper">
                    ...
                    <p>I started cycling, and I messed things up, a lot. But I gradually got smarter, fitter, and more confident. It was hard, really hard, but I loved it. And with each passing pedal stroke, my plans for the future grew larger and larger. "Why stop at just Asia?”, I thought. “If I’m going to do something, I might as well <i>really</i> do it, right?"</p>
                    <p>So, I decided to cycle the “rest of the world”—or at least two more thin slices of it that give the impression of this. I’ll cycle down from my home in the US to the bottom of the Americas, head on over to southern Africa, and then cycle back up to Istanbul where I first started for that satisfying closed loop. And, maybe somewhere in these thousands and thousands of miles, I’ll find the elusive elixir of happiness. At least, I hope to find that my legs stop hurting so much at some point.</p>
                </div>
            </div>
        </Layout>
        )
